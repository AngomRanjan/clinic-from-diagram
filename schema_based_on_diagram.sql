...
CREATE INDEX medical_history_id_asc ON treatment_histories (medical_histories_id ASC);
CREATE INDEX treatment_id_asc ON treatment_histories (treatment_id ASC);
